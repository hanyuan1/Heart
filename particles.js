function launchParticlesJS(a, e) {
    ...
    pJS.fn.vendors.distanceParticles = function(t, r) {
        ...
        if (s <= pJS.particles.line_linked.distance) {
            ...
            if (pJS.particles.line_linked.condensed_mode.enable) {
                var o = t.x - r.x, n = t.y - r.y, q = o / (pJS.particles.line_linked.condensed_mode.rotateX * 1000), p = n / (pJS.particles.line_linked.condensed_mode.rotateY * 1000);
                r.vx += q;
                r.vy += p
            }
        }
    ...
    pJS.fn.vendors.interactivity.grabParticles = function(r, q) {
        ...
        var t = r.x - pJS.interactivity.mouse.pos_x, n = r.y - pJS.interactivity.mouse.pos_y, o = Math.sqrt(t * t + n * n);
